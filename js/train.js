console.log("This is seat plan start")
...
function renderSeatplan(seatInfo) {
    ...
    var szCell = Size(
        Math.floor(rcContent.Size.Width / (ncolumns + 1) - 3)
        , Math.floor(rcContent.Size.Height / (nrows + 1) - 3)
    );
    ctx.font = "16px Arial";
...
console.log("This is seat plan end")
